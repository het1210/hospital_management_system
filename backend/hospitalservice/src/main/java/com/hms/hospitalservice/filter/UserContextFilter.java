package com.hms.hospitalservice.filter;
...
public class UserContextFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (username != null && rolesStr != null) {
            // Build GrantedAuthority list from comma-separated roles
            ...
            // Attach extra details (userId, hospitalId) for use in controllers
